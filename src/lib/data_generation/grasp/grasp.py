...
class Grasp():
    ...
    The grasp class
    """
    def __init__(self, open_width=0.08, color=[0, 255, 0], pose=None, kpts_option="hedron", kpts_color=[0, 0, 255], kpts_dist=0.1) -> None:
    ...
    def get_mesh(self, kpts=False, kpts_link=False, gripper_frame=False, world_frame=False):
        ...
        """
        gripper_mesh = self.generate_gripper_mesh(open_width = self.open_width, color= self.color)
