...
python test.py grasp_pose \
	--exp_id debug_test_${DATASET_NUM}_${CENTER_SUFFIX}_${KPT_SUFFIX} \
	--dataset ps_grasp \
	--keep_res \
	--load_model ../exp/grasp_pose/grasp_train_single_${DATASET_NUM}/model_best.pth \
	--not_prefetch_test \
	--trainval \
	--kpt_type box \
	--pnp_type cvIPPE \
